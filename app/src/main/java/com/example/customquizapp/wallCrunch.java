...
public class wallCrunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wall_crunch);
        ...
        tips.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(wallCrunch.this, wallcrunchtip.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(wallCrunch.this, WorkOut.class);
                startActivity(intent);
            }
        });
    }
