...
public class tricepTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tricep_time);
        ...
        tips.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(tricepTime.this, triceptip.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tricepTime.this, weightOut.class);
                startActivity(intent);
            }
        });
    }
